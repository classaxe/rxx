...
function tools() {
  ...
  $out[] =	"</form>\n";
  $out[] =	"<h1>Tools</h1>\n";
  $out[] =	"<p align='center'><small>Quick Links [\n";
  $out[] =	"<nobr><a href='#dgps'><b>DGPS Lookup</b></a></nobr> |\n";
  $out[] =	"<nobr><a href='#coords'><b>Co-ordinates Converter</b></a></nobr> |\n";
  $out[] =	"<nobr><a href='#navtex'><b>NAVTEX Missed Shift Translator</b></a></nobr> |\n";
  $out[] =	"<nobr><a href='#sunrise'><b>Sunrise Calculator</b></a></nobr> |\n";
  $out[] =	"<nobr><a href='#links'><b>Other NDB Databases</b></a></nobr>\n";
  $out[] =	"]</small></p><br><br>\n";

  $out[] =	tools_DGPS_lookup()."<br><br><br>\n";
  $out[] =	tools_coordinates_conversion()."<br><br><br>\n";
  $out[] =	tools_navtex_fixer()."<br><br><br>\n";
  $out[] =	tools_sunrise_calculator()."<br><br><br>\n";
  $out[] =	tools_links();
  $out[] =	"</form></span>\n";
  return implode($out,"");
}
...
// ************************************
// * tools_coordinates_conversion()   *
// ************************************
function tools_coordinates_conversion() {
  global $mode,$script,$GSQ;
  return "<script language='javascript' type='text/javascript'>\n"
	."function popup_map(call,lat,lon){\n"
	."  popWin('http://www.mapquest.com/maps/map.adp?latlongtype=decimal&latitude='+lat+'&longitude='+lon+'&size=big&zoom=5','popMap','scrollbars=1,resizable=1',600,600,'centre');\n"
	."}\n"
	."</script>"
	...
	.($mode=="tools" ?
	  ...
	  ."<a href=\"javascript:popWin('$script?mode=tools_coordinates_conversion','tools_coordinates_conversion','scrollbars=0,resizable=0',610,144,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></th>\n" : "")
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
	...
	."<input type='button' name='map' value='Map' onclick='if (conv_dd_mm_ss(document.coords)) { deg_gsq(document.coords);popup_map(\"5\",lat_dddd.value,lon_dddd.value);}' class='formButton'>\n"
	."<input type='button' name='photo' value='Photo' onclick='if (conv_dd_mm_ss(document.coords)) { deg_gsq(document.coords);popup_googlemap(\"5\",lat_dddd.value,lon_dddd.value);}' class='formButton'></td>\n"
	."  </tr>\n"
	."  <tr>\n"
	...
	."<input type='button' name='map2' value='Map' onclick='if (conv_dd_dddd(document.coords)) { deg_gsq(document.coords);popup_map(\"5\",lat_dddd.value,lon_dddd.value);}' class='formButton'>\n"
   	."<input type='button' name='photo2' value='Photo' onclick='if (conv_dd_dddd(document.coords)) { deg_gsq(document.coords);popup_googlemap(\"5\",lat_dddd.value,lon_dddd.value);}' class='formButton'></td>\n"
    ."  </tr>\n"
	."  <tr>\n"
	...
	."<input type='button' name='map3' value='Map' onclick='if (gsq_deg(document.coords)) { conv_dd_dddd(document.coords);popup_map(\"5\",lat_dddd.value,lon_dddd.value);}' class='formButton'>\n"
	."<input type='button' name='photo3' value='Photo' onclick='if (gsq_deg(document.coords)) { conv_dd_dddd(document.coords);popup_googlemap(\"5\",lat_dddd.value,lon_dddd.value);}' class='formButton'></td>\n"
	."  </tr>\n"
	."  <tr>\n"
...
function tools_DGPS_lookup() {
  global $script, $mode;
  return "<script language='JavaScript' type='text/javascript' src='$script?mode=export_javascript_DGPS'></script>\n"
	."<script language='javascript' type='text/javascript'>\n"
	."function signal_info(ID){\n"
	."  popWin('./?mode=signal_info&ID='+ID,'popsignal','scrollbars=0,resizable=1',640,380,'centre');\n"
	."}\n"
	."</script>\n"
	...
	.($mode=="tools" ?
	   "        <th align='right' class='downloadTableHeadings_nosort'>"
	  ."<a href=\"javascript:popWin('$script?mode=tools_DGPS_popup','tools_DGPS_popup','scrollbars=0,resizable=0',347,227,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></th>\n" : "")
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
...
function tools_navtex_fixer() {
  ...
  return
	...
	.($mode=="tools" ?
	   "        <th align='right' class='downloadTableHeadings_nosort'>"
	  ."<a href=\"javascript:popWin('$script?mode=tools_navtex_fixer','tools_navtex_fixer','scrollbars=0,resizable=0',420,390,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></th>\n" : "")
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
...
function tools_links() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	.($mode=="tools" ?
	   "        <th align='right' class='downloadTableHeadings_nosort'>"
	  ."<a href=\"javascript:popWin('$script?mode=tools_links','tools_links','scrollbars=0,resizable=0',520,112,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></th>\n" : "")
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
...
// ************************************
// * tools_sunrise_calculator()       *
// ************************************
function tools_sunrise_calculator() {
  global $mode,$script;
  return "<script language='JavaScript' type='text/javascript' src='../assets/sunrise.js'></script>\n"
	...
	.($mode=="tools" ?
	   "        <th align='right' class='downloadTableHeadings_nosort'>"
	  ."<a href=\"javascript:popWin('$script?mode=tools_sunrise_calculator','tools_sunrise_calculator','scrollbars=0,resizable=0',455,312,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></th>\n" : "")
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
	...
	."      </tr>\n"
	."      <tr ALIGN=\"CENTER\">\n"
	."        <td class='downloadTableContent' COLSPAN=\"2\">Sunrise Calculator code kindly provided by <a href='http://www.csgnetwork.com' target='_blank'><b>CSG Network</b><br><img src='../assets/csglogo2.jpg' width='185' height='74' border='1'></a><br>(Ver. 14.7.2, used with permission)\n"
	."        </td>\n"
	."      </tr>\n"
	."      <tr ALIGN=\"CENTER\">\n"
