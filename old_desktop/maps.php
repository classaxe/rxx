...
function map_af() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."<a href='javascript:show_itu(\"af\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_af','map_af','scrollbars=0,resizable=0',646,652,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
...
function map_alaska() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_alaska','map_alaska','scrollbars=0,resizable=0',466,411,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
...
function map_as() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>"
	."<a href='javascript:show_itu(\"as\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_as','map_as','scrollbars=0,resizable=0',856,575,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
...
function map_au() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>"
	."<a href='javascript:show_itu(\"oc\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	."<a href='javascript:show_sp()' title='NDBList Territory codes'><img src='../assets/icon-territory-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_au','map_au','scrollbars=0,resizable=0',511,469,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
	."    <td class='downloadTableContent' align='center'><img src='../../images/au_map.gif'></td>\n"
	."  </tr>\n"
	."</table>\n";
}
...
function map_eu() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>"
	."<a href='javascript:show_itu(\"eu\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_eu','map_eu','scrollbars=0,resizable=0',704,696,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
	."    <td class='downloadTableContent'><img src='$script?mode=generate_map_eu'></td>\n"
	."  </tr>\n"
	."</table>\n";
}
...
function map_japan() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."<a href='javascript:show_itu(\"as\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_japan','map_japan','scrollbars=0,resizable=0',517,690,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
...
function map_na() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>"
	."<a href='javascript:show_itu(\"na\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	."<a href='javascript:show_sp()' title='NDBList State and Province codes'><img src='../assets/icon-state-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_na','map_na','scrollbars=0,resizable=0',669,651,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
	."    <td class='downloadTableContent' align='center'><img src='$script?mode=generate_map_na'></td>\n"
	."  </tr>\n"
	."</table>\n";
}
...
function map_pacific() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."<a href='javascript:show_itu(\"oc\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_pacific','map_pacific','scrollbars=0,resizable=0',366,429,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
...
function map_place_finder() {
  global $script,$mode,$submode,$place;
  if (!isset($place)) {
    $place='';
  }
  $out = array();
  ...
  $out[]="<form name='form' action='$script' method='post'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'><a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a></th>\n"
	."      </tr>\n"
	."    </table></th>\n"
	."  </tr>\n"
	."  <tr>\n"
...
function map_polynesia() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_polynesia','map_polynesia','scrollbars=0,resizable=0',458,440,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
...
function map_sa() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."        <th align='right' class='downloadTableHeadings_nosort'>"
	."<a href='javascript:show_itu(\"sa\")' title='NDBList Country codes'><img src='../assets/icon-country-codes.gif' border='0'></a>\n"
	.($mode=="maps" ?
	   "<a href=\"javascript:popWin('$script?mode=map_sa','map_sa','scrollbars=0,resizable=0',499,696,'centre')\"><img src='../assets/icon-popup.gif' border='0'></a>\n"
	  ."<a href='#top' class='yellow'><img src='../assets/icon-top.gif' border='0'></a>\n":"")
	."</th>\n"
	."      </tr>\n"
	."    </table></th>\n"
...
function map_state_popup() {
  ...
  return "<table cellpadding='2' border='0' cellspacing='1' class='downloadtable'>\n"
	...
	."  </tr>\n"
	."  <tr>\n"
	."    <td class='downloadTableContent'>Click <a href='./?mode=state_map&simple=1&SP=AK' target='_blank'><b>here</b></a> to see detailed customisable maps for each US state.</td>\n"
	."  </tr>\n"
	."</table>\n";
}
...
function maps_reu() {
  global $script;
  return "<h1>Maps for European Listeners</h1>\n"
...
//http://earth-info.nga.mil/gns/html/index.html
  $out = array();
  return "<h1>Maps for North American Listeners</h1>\n"
	."<p align='center'><small>Quick Links [\n"
...
function maps_rww() {
  global $script;
  return "<h1>Maps for All Listeners</h1>\n"
	."<p align='center'><small>Quick Links [\n"
	."<nobr><a href='#na'><b>North + Central America</b></a></nobr> |\n"
	."<nobr><a href='#sa'><b>South America</b></a></nobr> |\n"
	."<nobr><a href='#eu'><b>Europe</b></a></nobr> |\n"
...
function state_map() {
  ...
  $out[] =	 "<script language='javascript' type='text/javascript'>\n"
		...
		." }\n"
		."</script>"
		."<form name='form' action='$script' method='GET'>\n"
		."<input type='hidden' name='mode' value='$mode'>\n"
  ...
  $out[] =	 "            </select></td>\n"
		...
		."          <tr>\n"
		."            <td align='right' width='20'><img src='../assets/map_point_DGPS.gif' alt='Represents a DGPS station'></td>\n"
		."            <th align='left' nowrap>DGPS Station</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_HAMBCN.gif' alt='Represents an amateur radio beacon'></td>\n"
		."            <th align='left' nowrap>Ham Beacon</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_NAVTEX.gif' alt='Represents a NAVTEX station'></td>\n"
		."            <th align='left' nowrap>NAVTEX Station</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_NDB.gif' alt='Represents an NDB'></td>\n"
		."            <th align='left' nowrap>NDB</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_TIME.gif' alt='Represents a Time Signal station'></td>\n"
		."            <th align='left' nowrap>Time Station</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_OTHER.gif' alt='Represents a form of transmitter not otherwise classified'></td>\n"
		."            <th align='left' nowrap>Other</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_inactive.gif' alt='Represents an inactive or decommissioned transmitter'></td>\n"
		."            <th align='left' nowrap>Inactive</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_capital.gif' alt='Represents a state capital'></td>\n"
		."            <th align='left' nowrap>State Capital</th>\n"
		."          </tr>\n"
		."          <tr>\n"
		."            <td align='right'><img src='../assets/map_point_place.gif' alt='Represents other populated place'></td>\n"
...
function map_locator() {
  ...
  $out[] =   "<script language='javascript' type='text/javascript'>\n"
            ...
            ."current_ypos = $map_y;\n"
            ."if (isNS4) {\n"
            ."  document.write(\"<layer name='point_here'><img src='../assets/cursor_map.gif' onmousedown='(!isNS6 ? xy(window.event.x,window.event.y) : xy(event.pageX,event.pageY));'></layer>\");\n"
            ."}\n"
            ."else {\n"
            ."  document.write(\"<div ID='point_here' style='position: absolute; display: none;'><img src='../assets/cursor_map.gif' onmousedown='(!isNS6 ? xy(window.event.x,window.event.y) : xy(event.pageX,event.pageY));'></div>\");\n"
            ."}\n"
  ...
  $out[] =   "galleryimg='no' onmousedown='(!isNS6 ? xy(window.event.x,window.event.y) : xy(event.pageX,event.pageY));'\n"
            ."></td>\n"
            ."  </tr>\n"
            ."  <tr>\n"
            ...
            ."        <td><input type='button' value='Save' onclick=\"if (window.opener && window.opener.form && confirm('Save changes for this listener?')) { window.opener.form.map_x.value=document.form.map_x.value; window.opener.form.map_y.value=document.form.map_y.value; window.opener.form.save.onclick(); window.close();}\"></td>\n"
            ."      </tr>\n"
            ."    </table></form></td>\n"
            ."  </tr>\n"
            ."</table>"
