...
CAB+CAF+CAN+CBG+CEU+CHL+CHN+CHR+CKH+CKS+CLI+CLM+CLN+CME+CNR+COD+COG+COM+COR+CPV+CTI+CTR+CUB+CVA+CYM+CYP+CZE
DES+DEU+DGA+DJI+DMA+DNK+DOM
EGY+ENG+EQA+ERI+ESP+EST+ETH+EUR
FDN+FIN+FJI+FLK+FRA+FRO+FSM
GAB+GAL+GDL+GEO+GHA+GIB+GLO+GMB+GNB+GNE+GRC+GRD+GRL+GSY+GTM+GUF+GUI+GUM+GUY
HND+HNG+HOL+HRV+HTI+HWA+HWL
ICO+IND+INS+IOM+IRL+IRN+IRQ+ISL+ISR+ITA
JAR+JDN+JMC+JMY+JON+JOR+JPN+JSY
KAL+KAZ+KEN+KGZ+KIR+KOR+KRE+KWT
LAO+LBN+LBR+LBY+LCA+LHI+LIE+LIN+LIS+LSO+LTU+LUX+LVA
MAR+MAU+MCO+MDA+MDG+MDR+MDW+MEL+MEX+MHL+MKD+MLA+MLD+MLI+MLT+MNE+MNG+MOZ+MRA+MRC+MRT+MSR+MTN+MTS+MWI+MYT
NAK+NCG+NCL+NFK+NGR+NIG+NIR+NIU+NMB+NOR+NPL+NRU+NZL
OCE+OGA+OMA+ORK+OTS
PAK+PAQ+PHL+PHX+PLM+PLW+PNG+PNR+POL+POR+PPR+PRG+PRU+PTC+PTR
QAT
REU+ROC+ROU+RRW+RSE+RUS+RYI
SAP+SAR+SCN+SCT+SCY+SDN+SEN+SEY+SHE+SHN+SLM+SLV+SMA+SMO+SMR+SNG+SOM+SPM+SPR+SRB+SRL+STP+SUI+SUR+SVB+SVK+SVN+SWE+SWN+SWZ+SYR
TCA+TCD+TGO+THA+TJK+TKL+TKM+TMP+TMV+TON+TRC+TRD+TRO+TUA+TUN+TUR+TUV+TWN+TZA
UAE+UGA+UKR+URG+USA+UZB
VCT+VEN+VIR+VOI+VPG+VPH+VPO+VPS+VRG+VTN+VUT
WAK+WAL+WBG+WLS
XOA+XOC+XOE+XOF+XON+XOP+XOS+XUA+XUC+XUE+XUF+XUN+XUP+XUS+XUU
YEM
ZMB+ZWE
...
NB+NC+ND+NE+NH+NJ+NL+NM+NN+NS+NT+NU+NV+NW+NY
OH+OK+ON+OR
PA+PE+PR
QC+QD
RI
...
function cle() {
  ...
  $out =
     "<h1>CLE ".$record['cle']." Seek Lists and Signal Lists "
    .($isAdmin ?
  ...
  if ($isAdmin) {
    $out.=
       "<script type=\"text/javascript\" src=\"../assets/calendar_db.js\"></script>\n"
      ...
      ."    </td>\n"
      ."    <td>\n"
      ."      <input type='text' name='europe_range_2_filter_other' id='europe_range_2_filter_other' value=\"".$eu_b_filter_other."\" style='text-align:left;width:220px;' />\n"
      ."    </td>\n"
      ."  </tr>\n"
      ."  <tr>\n"
      ."    <th>Text Suffix</th>\n"
  ...
  $out.=
    ...
    ."    <td><a href='../reu/?mode=signal_list".$eu_a_url."'>".$eu_a_text."</a>"
    .($eu_b_khz_l ? "<br /><a href='../reu/?mode=signal_list".$eu_b_url."'>".$eu_b_text."</a>" : "")
    ."<br>&nbsp;</td>\n"
    ."  </tr>\n"
    ."  <tr>\n"
    ."    <td valign='top'>Signal Seeklist</td>\n"
    ."    <td><a href='../reu/?mode=signal_seeklist".$eu_a_url."'>".$eu_a_text."</a>"
    .($eu_b_khz_l ? "<br /><a href='../reu/?mode=signal_seeklist".$eu_b_url."'>".$eu_b_text."</a>" : "")
    ."</td>\n"
    ."  </tr>\n"
    ."</table>\n"
    ."<br><br></li>"
    ...
    ."  <tr>\n"
    ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
    ."    <td><a href='../rna/?mode=signal_list".$a_url."'>".$a_text."</a>"
    .($b_khz_l ? "<br><a href='../rna/?mode=signal_list".$b_url."'>".$b_text."</a>" : "")
    ."<br>&nbsp;</td>\n"
    ."  </tr>\n"
    ."  <tr>\n"
    ."    <td valign='top'>Signal Seeklist</td>\n"
    ."    <td><a href='../rna/?mode=signal_seeklist".$a_url."'>".$a_text."</a>"
    .($b_khz_l ? "<br><a href='../rna/?mode=signal_seeklist".$b_url."'>".$b_text."</a>" : "")
    ."</td>\n"
    ."  </tr>\n"
    ."</table>\n"
    ."<br><br></li>"
    ...
    ."  <tr>\n"
    ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
    ."    <td><a href='../rww/?mode=signal_list&amp;region=sa".$a_url."'>".$a_text."</a>"
    .($b_khz_l ? "<br><a href='../rww/?mode=signal_list&amp;region=sa".$b_url."'>".$b_text."</a>" : "")
    ."<br>&nbsp;</td>\n"
    ."  </tr>\n"
    ."  <tr>\n"
    ."    <td valign='top'>Signal Seeklist</td>\n"
    ...
    ."  <tr>\n"
    ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
    ."    <td><a href='../rww/?mode=signal_list&amp;region=oc".$a_url."'>".$a_text."</a>"
    .($b_khz_l ? "<br><a href='../rww/?mode=signal_list&amp;region=oc".$b_url."'>".$b_text."</a>" : "")
    ."<br>&nbsp;</td>\n"
    ."  </tr>\n"
    ."  <tr>\n"
    ."    <td valign='top'>Signal Seeklist</td>\n"
    ...
    ."  <tr>\n"
    ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
    ."    <td><a href='../rww/?mode=signal_list&amp;region=as".$a_url."'>".$a_text."</a>"
    .($b_khz_l ? "<br><a href='../rww/?mode=signal_list&amp;region=as".$b_url."'>".$b_text."</a>" : "")
    ."<br>&nbsp;</td>\n"
    ."  </tr>\n"
    ."  <tr>\n"
    ."    <td valign='top'>Signal Seeklist</td>\n"
    ...
    ."  <tr>\n"
    ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
    ."    <td><a href='../rww/?mode=signal_list&amp;region=af".$a_url."'>".$a_text."</a>"
    .($b_khz_l ? "<br><a href='../rww/?mode=signal_list&amp;region=af".$b_url."'>".$b_text."</a>" : "")
    ."<br>&nbsp;</td>\n"
    ."  </tr>\n"
    ."  <tr>\n"
    ."    <td valign='top'>Signal Seeklist</td>\n"
