 ...
 */
   ...
   * Tries to use PHP built-in validator in the filter extension (from PHP 5.2),
   * falls back to a reasonably competent regex validator
  ...
  */
   ...
   */
    ...
    {
        $this->error_count++;
        if ($this->Mailer == 'smtp' and !is_null($this->smtp) and method_exists($this->smtp, 'getError')) {
  ...
  */
   ...
   */
    public function DKIM_Add($headers_line, $subject, $body)
    {
        ...
        $dkimhdrs =
                "DKIM-Signature: v=1; a=" . $DKIMsignatureType . "; q=" . $DKIMquery . "; ".
