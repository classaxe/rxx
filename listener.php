...
function listener_list() {
  ...
  switch ($sortBy) {
    ...
    case "count_DSC":		$sortBy_SQL =	"`count_DSC`=0, `count_DSC` ASC";                       break;
    case "count_DSC_d":     $sortBy_SQL =	"`count_DSC`=0, `count_DSC` DESC";                      break;
  ...
  if (mysql_num_rows($result)) {
    $out.=
	  ...
	  .(system=="RWW" || system=="RNA" ?
          "    ".show_sortable_column_head("Sort by Continent","<img src='".BASE_PATH."assets/txt_continent.gif' alt='Continent'>",$sortBy,"region","A-Z",true)
       :
	      ""
       )
	  ."    ".show_sortable_column_head("Sort by GSQ Grid Locator Square","GSQ",$sortBy,"GSQ","A-Z",false)
	  ."    ".show_sortable_column_head("Sort by Time zone (relative to UTC)","<img src='".BASE_PATH."assets/txt_timezone.gif' alt='Timezone'>",$sortBy,"timezone","A-Z",true)
	  ...
	  .($type_DGPS ?   "    ".show_sortable_column_head("Sort by DGPS count","<img src='".BASE_PATH."assets/txt_DGPS.gif' alt='DGPS'>",$sortBy,"count_DGPS","Z-A",true) : "")
	  .($type_DSC ?   "    ".show_sortable_column_head("Sort by DSC count","<img src='".BASE_PATH."assets/txt_DSC.gif' alt='DSC'>",$sortBy,"count_DSC","Z-A",true) : "")
	  .($type_HAMBCN ? "    ".show_sortable_column_head("Sort by Amateur Radio signal count","<img src='".BASE_PATH."assets/txt_HAMBCN.gif' alt='HAM'>",$sortBy,"count_HAMBCN","Z-A",true) : "")
	  .($type_NAVTEX ? "    ".show_sortable_column_head("Sort by NAVTEX station count","<img src='".BASE_PATH."assets/txt_NAVTEX.gif' alt='NAVTEX'>",$sortBy,"count_NAVTEX","Z-A",true) : "")
	  .($type_NDB ?    "    ".show_sortable_column_head("Sort by NDB count","<img src='".BASE_PATH."assets/txt_NDB.gif' alt='NDB'>",$sortBy,"count_NDB","Z-A",true) : "")
	  .($type_OTHER ?  "    ".show_sortable_column_head("Sort by Other stations count","<img src='".BASE_PATH."assets/txt_OTHER.gif' alt='OTHER'>",$sortBy,"count_OTHER","Z-A",true) : "")
	  .($type_TIME ?   "    ".show_sortable_column_head("Sort by Time Station count","<img src='".BASE_PATH."assets/txt_TIME.gif' alt='Time signal station'>",$sortBy,"count_TIME","Z-A",true) : "")
    ...
    for ($i=0; $i<mysql_num_rows($result); $i++) {
      ...
      $out.=
        ...
        .($row['primary_QTH'] ?
            "<b>".highlight(stripslashes($row["name"]),$filter)."</b>"
          :
...
//        ."<td>".($notes ? $notes : "&nbsp;")."</td>\n"
        ...
        .($type_DGPS ?   "<td bgcolor='".Signal::$colors[DGPS]."' nowrap align='right'>".($row["count_DGPS"]   ? $row["count_DGPS"] :   "&nbsp;")."</td>" : "")
        .($type_DSC ?    "<td bgcolor='".Signal::$colors[DSC]."' nowrap align='right'>".($row["count_DSC"]   ? $row["count_DSC"] :   "&nbsp;")."</td>" : "")
        .($type_HAMBCN ? "<td bgcolor='".Signal::$colors[HAMBCN]."' nowrap align='right'>".($row["count_HAMBCN"] ? $row["count_HAMBCN"] : "&nbsp;")."</td>" : "")
        .($type_NAVTEX ? "<td bgcolor='".Signal::$colors[NAVTEX]."' nowrap align='right'>".($row["count_NAVTEX"] ? $row["count_NAVTEX"] : "&nbsp;")."</td>" : "")
        .($type_NDB ?    "<td bgcolor='".Signal::$colors[NDB]."' nowrap align='right'>".($row["count_NDB"]    ? $row["count_NDB"] :    "&nbsp;")."</td>" : "")
        .($type_OTHER ?  "<td bgcolor='".Signal::$colors[OTHER]."' nowrap align='right'>".($row["count_OTHER"]  ? $row["count_OTHER"] :  "&nbsp;")."</td>" : "")
        .($type_TIME ?   "<td bgcolor='".Signal::$colors[TIME]."' nowrap align='right'>".($row["count_TIME"]   ? $row["count_TIME"] :   "&nbsp;")."</td>" : "")
        .(strlen($type_NDB.$type_DSC.$type_DGPS.$type_TIME.$type_HAMBCN.$type_NAVTEX.$type_OTHER)>1 ?
...
function listener_log() {
  ...
  foreach ($log_arr as $row) {
    ...
    if (!$row["active"]) {
      ...
      switch ($row["type"]) {
        case DGPS:	    $title = " title='DGPS Station'";               break;
        case DSC:	    $title = " title='DSC Station'";                break;
        case HAMBCN:	$title = " title='Amateur signal'";             break;
        case NAVTEX:	$title = " title='NAVTEX Station'";             break;
        case NDB:	    $title = "";                                    break;
        case OTHER:	    $title = " title='Other form of transmission'"; break;
        case TIME:	    $title = " title='Time Signal Station'";        break;
      }
    }
    $out.=
       "<tr".$bgcolor.$title.">"
...
function listener_stats() {
  ...
  return
    ...
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[DGPS]."' width='120'><b>DGPS Stations:</b></td>\n"
    ."                <td class='downloadTableContent'>".$row['count_DGPS']."</td>\n"
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[DSC]."' width='120'><b>DSC Stations:</b></td>\n"
    ."                <td class='downloadTableContent'>".$row['count_DSC']."</td>\n"
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[HAMBCN]."'><b>Ham Beacons:</b></td>\n"
    ."                <td class='downloadTableContent'>".$row['count_HAMBCN']."</td>\n"
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[NAVTEX]."'><b>Navtex stations:</b></td>\n"
    ."                <td class='downloadTableContent'>".$row['count_NAVTEX']."</td>\n"
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[NDB]."'><b>NDBs:</b></td>\n"
    ."                <td class='downloadTableContent'>".$row['count_NDB']."</td>\n"
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[TIME]."'><b>Time Signal:</b></td>\n"
    ."                <td class='downloadTableContent'>".$row['count_TIME']."</td>\n"
    ."              </tr>\n"
    ."              <tr>\n"
    ."                <td bgcolor='".Signal::$colors[OTHER]."'><b>Other:</b></td>\n"
