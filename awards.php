...
Version History:
  1.0.2 (2013-03-18)
    1) Converted to object, broke into sub-functions, simplified tables and
       eliminated array concat methods
  1.0.1 (2009-11-19)
...
function awards() {
  $Obj_awards = new Awards;
  return $Obj_awards->draw();
}
...
class Awards{
  ...
  private function _draw_award_transpacific(){
    ...
    if (
      ...
      $this->_listener_region!="as" && $this->_listener_ITU!="AUS" && $this->_listener_ITU!="NZL" &&
    ...
    $sql =
      ...
      ."  `signals`.`ITU` = `itu`.`ITU` AND\n"
      .(
        ($this->_listener_region=="na" or $this->_listener_region=="ca" or $this->_listener_region=="sa") ?
