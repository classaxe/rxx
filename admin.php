...
function admin_manage()
{
    ...
    switch ($submode) {
        ...
        case "admin_importICAO":
            $out.= admin_importICAO();
            break;
        case "admin_setDaytimeLogs":
            $out.= admin_setDaytimeLogs();
            break;
        case "admin_signalUpdateRegionsHeard":
            $out.= admin_signalUpdateRegionsHeard()." stations updated";
            break;
        case "admin_signalUpdateLogCount":
            $out.= admin_signalUpdateLogCount();
            break;
        case "admin_signalUpdateFromGSQ":
            $out.= admin_signalUpdateFromGSQ();
            break;
        case "admin_listenersUpdateLogCount":
            $out.= admin_listenersUpdateLogCount();
            break;
