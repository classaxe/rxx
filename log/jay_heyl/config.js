...
qth_lat =    28.3908;               // Replace with your decimal latitude
qth_lon =    -81.4292;              // Replace with your decimal latitude
qth_name =   "Jay Heyl";            // Replace with your name
qth_home =   "";                  // Replace with your web site address or "" if none
qth_email =  "jay@frelled.us";      // Replace with your email or "" if none
