...
COUNTRY ("XUA","UNID (Probable Location: Asia)","as");
COUNTRY ("XUC","UNID (Probable Location: Central America & Caribbean)","ca");
COUNTRY ("XUE","UNID (Probable Location: Europe)","eu");
COUNTRY ("XUF","UNID (Probable Location: Africa)","af");
COUNTRY ("XUN","UNID (Probable Location: North America)","na");
COUNTRY ("XUP","UNID (Probable Location: Oceania)","oc");
COUNTRY ("XUS","UNID (Probable Location: South America)","sa");
