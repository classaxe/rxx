...
qth_lat =   60;               // Replace with your decimal latitude
qth_lon =    26;              // Replace with your decimal latitude
qth_name =   "Kari Syrjänen, OH5YW";      // Replace with your name
qth_home =   "";    // Replace with your web site address or "" if none
qth_email =  "beaconhunter (at) gmail.com"; // Replace with your email or "" if none
monthly =    1;                     // 1 for monthly, 0 for lifetime format
utc_offset =+2;                     // Replace for your timezone information.
