...
qth_lat =    -37.4833;               // Replace with your decimal latitude
qth_lon =    144.5833;              // Replace with your decimal latitude
qth_name =   "Martin Francis, Gisborne DX Tuner Node";      // Replace with your name
qth_home =   "http://www.dxtuner.com/";    // Replace with your web site address or "" if none
qth_email =  "martin@classaxe.com"; // Replace with your email or "" if none
monthly =    1;                     // 1 for monthly, 0 for lifetime format
utc_offset = -10;                     // Replace for your timezone information.
