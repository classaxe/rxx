...
qth_lat =    37.6739;               // Replace with your decimal latitude
qth_lon =    -122.4756;              // Replace with your decimal latitude
qth_name =   "Michael Silvers";      // Replace with your name
qth_home =   "";    // Replace with your web site address or "" if none
qth_email =  "silversmj@yahoo.com"; // Replace with your email or "" if none
monthly =    1;                     // 1 for monthly, 0 for lifetime format
utc_offset = 8;                     // Replace for your timezone information.
