...
qth_lat =    47.0737;               // Replace with your decimal latitude
qth_lon =    -70.909;               // Replace with your decimal latitude
qth_name =   "Martin Francis (Mont St Anne, Quebec, Canda)";      // Replace with your name
qth_home =   "../../../index.html";    // Replace with your web site address or "" if none
qth_email =  "martin@classaxe.com"; // Replace with your email or "" if none
monthly =    1;                     // 1 for monthly, 0 for lifetime format
utc_offset = 0;                     // Replace for your timezone information.
