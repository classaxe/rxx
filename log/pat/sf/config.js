...
qth_lat =    43.0833;                  // Replace with your decimal latitude
qth_lon =    5.8167;                   // Replace with your decimal latitude
qth_name =   "Patrick Vignoud (Six-Four-Les-Plages)"; // Replace with your name
qth_home =   "";                       // Replace with your web site address or "" if none
qth_email =  "aunumero13@wanadoo.fr";  // Replace with your email or "" if none
monthly =    1;                        // 1 for monthly, 0 for lifetime format
