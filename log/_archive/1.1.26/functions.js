...
function popup_details(id) {
  ...
  if (logbook[id]) {
    out[n++] =	"<h3>Reception Details for "+station[id].display+"</h3><table border='"+((document.all)?("0"):("1"))+"' cellspacing='0' cellpadding='1'>\n";
...
function rww(ID) {
  popWin('/dx/ndb/rww/signal_info/'+ID,'popsignal','scrollbars=0,resizable=1',640,380,'centre');
}
