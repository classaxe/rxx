...
class Tools
{
    ...
    public static function tools_DGPS_lookup()
    {
        ...
        return
            ...
            .(system=="REU" ?
                ...
                . "<a href=\"javascript:document.dgps.ref.value='823';document.dgps.go.click();\"><b>823</b></a> are for station <a href=\"javascript:signal_info('2777')\"><b>#492</b></a>"
    ...
    public static function tools_navtex_fixer()
    {
        ...
        return
            ...
            . ($mode=="tools" ?
                "        <th align='right' class='downloadTableHeadings_nosort'>"
                . "<a href=\"javascript:popWin('".system_URL."/tools_navtex_fixer','tools_navtex_fixer','scrollbars=0,resizable=0',420,370,'centre')\">"
                . "<img src='".BASE_PATH."assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='".BASE_PATH."assets/icon-top.gif' border='0'></th>\n"
            : ""
            )
            . "      </tr>\n"
    ...
    public static function tools_links()
    {
        ...
        return
            ...
            . ($mode=="tools" ?
                "        <th align='right' class='downloadTableHeadings_nosort'>"
                . "<a href=\"javascript:popWin('".system_URL."/tools_links','tools_links','scrollbars=0,resizable=0',520,130,'centre')\">"
                . "<img src='".BASE_PATH."assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='".BASE_PATH."assets/icon-top.gif' border='0'></th>\n"
            : ""
            )
            . "      </tr>\n"
    ...
    public static function tools_sunrise_calculator()
    {
        global $mode;
        return
            "<script language='JavaScript' type='text/javascript' src='".BASE_PATH."assets/sunrise.js'></script>\n"
            ...
            . ($mode=="tools" ?
                "        <th align='right' class='downloadTableHeadings_nosort'>"
                . "<a href=\"javascript:popWin('".system_URL."/tools_sunrise_calculator','tools_sunrise_calculator','scrollbars=0,resizable=0',455,312,'centre')\">"
                . "<img src='".BASE_PATH."assets/icon-popup.gif' border='0'></a> <a href='#top' class='yellow'><img src='".BASE_PATH."assets/icon-top.gif' border='0'></th>\n"
            : ""
            )
            . "      </tr>\n"
