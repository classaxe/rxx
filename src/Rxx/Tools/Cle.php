...
class Cle
{
    ...
    public static function cle()
    {
        ...
        if (!$special) {
            $out.=
                 "<ul>\n"
                ."  <li><b style='color:#00f'>RNA</b><ul>\n"
                ."<li><b>North American Listeners:</b><br>"
                ."<table cellpadding='0' cellspacing='0' border='0' style='margin:0.5em 0 0.5em 2em'>\n"
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
                ...
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."rna/signal_list?".$a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rna/signal_list?".$b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
                ...
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."reu/signal_list?".$eu_a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$eu_a_text."</a>"
                .($eu_b_khz_l ? "<br /><a href='".BASE_PATH."reu/signal_list?".$eu_b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$eu_b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
                ...
                ."</table>\n"
                ."<br><br></li></ul></li>"
                ."  <li><b style='color:#0a0'>RWW</b><ul>\n"
                ."  <li><b>Worldwide Listeners:</b><br>"
                ."<table cellpadding='0' cellspacing='0' border='0' style='margin:0.5em 0 0.5em 2em'>\n"
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Detailed Signal List</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_list?".$a_url."'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_list?".$b_url."'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_list?".$a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_list?".$b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_seeklist?".$a_url."'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_seeklist?".$b_url."'>".$b_text."</a>" : "")
                ."</td>\n"
                ."  </tr>\n"
                ."</table>\n"
                ."<br></li>"
                ...
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_list?region=af&amp;".$a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_list?region=af&amp;".$b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
                ...
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_list?region=as&amp;".$a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_list?region=as&amp;".$b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
                ...
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_list?region=oc&amp;".$a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_list?region=oc&amp;".$b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
                ...
                ."  <tr>\n"
                ."    <td width='140' valign='top'>Active Signals Map</td>\n"
                ."    <td><a href='".BASE_PATH."rww/signal_list?region=sa&amp;".$a_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$a_text."</a>"
                .($b_khz_l ? "<br><a href='".BASE_PATH."rww/signal_list?region=sa&amp;".$b_url."&amp;show=map&amp;limit=-1&amp;filter_active=1'>".$b_text."</a>" : "")
                ."<br>&nbsp;</td>\n"
                ."  </tr>\n"
                ."  <tr>\n"
                ."    <td valign='top'>Signal Seeklist</td>\n"
