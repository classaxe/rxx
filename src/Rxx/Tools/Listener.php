...
class Listener
{
    ...
    public static function listener_list()
    {
        ...
        if (\Rxx\Rxx::isAdmin() && (!defined('READONLY') || !READONLY)) {
            ...
            $listener_arr = array();
            for ($i=0; $i<\Rxx\Database::numRows($result); $i++) {
                $listener_arr[] =    \Rxx\Database::fetchArray($result, MYSQLI_ASSOC);
            }
    ...
    public static function listener_QNH()
    {
        ...
        $out.=
            ...
            ."<input type='button' value='METAR' class='formButton' "
            ."onclick='"
            ."popWin(\"https://www.aviationweather.gov/metar/data"
            ."?ids=\"+document.pressure.ICAO_listener.value+\""
            ."&format=raw&hours=18&taf=on&layout=off"
            ."&hours+\"+document.pressure.hours_listener.value,"
            ."\"popMETAR\","
            ."\"scrollbars=1,resizable=1,location=1\",640,380,\"\");'>\n"

            ."<input type='button' value='Decoded' class='formButton' "
            ."onclick='"
            ."popWin(\"https://www.aviationweather.gov/metar/data"
            ."?ids=\"+document.pressure.ICAO_listener.value+\""
            ."&format=decoded&hours=18&taf=on&layout=off"
            ."&hours+\"+document.pressure.hours_listener.value,"
            ."\"popDecoded\","
            ."\"scrollbars=1,resizable=1,location=1\",640,380,\"\");'><br>\n"
